...
*Delivery*
The delivery date is defined as the moment when a visit that has been categorized as a 'delivery' *visit_type* has taken place. 

## Visit types
Visits are defined by the type of items billed during that encounter. The type of item is derived from the *item_group*. 
...
## Medication and DiagnosticReport measures
